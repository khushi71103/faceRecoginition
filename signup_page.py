...
class SignUp:
    def __init__(self, root):
        ...
        self.bg_img = ImageTk.PhotoImage(file=r"C:\Users\Khushi Chhetri\OneDrive\Desktop\Face recognition system\images\vivid-color-pattern-grafiti-draws-doodle-art-pattern-halloween-for-textiles-children-s-clothing-cool-background-vector.webp")
