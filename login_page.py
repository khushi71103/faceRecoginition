...
class login_page:
    def __init__(self, root):
        ...
        label1 = Label(self.frame1, text= "Welcome", font=("times new roman", 40, "bold"), bg="yellow", fg="red").place(x=100,y=300)
        #label2 = Label(self.frame1, text= "", font=("times new roman", 40, "bold"), bg="yellow", fg="RoyalBlue1").place(x=162,y=300)
        label3 = Label(self.frame1, text= "It's all about AI", font=("times new roman", 13, "bold"), bg="yellow", fg="brown4").place(x=100,y=360)
            ...
            try:
                ...
                if row == None:
                    ...
                    if open_main>0:
                        ...
                        self.app=Face_recognition_system(self.window)
                        messagebox.showinfo("Success","Wellcome to the AI attendance system",parent=self.window)
                    else:
                        if not open_main:
                            return
